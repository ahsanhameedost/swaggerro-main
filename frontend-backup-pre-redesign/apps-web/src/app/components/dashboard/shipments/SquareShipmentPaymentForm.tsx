...
import { useCreateShipmentPayment } from "@/queries/shipping";

type SquareShipmentPaymentFormProps = {
  shipmentId: string;
  amount: number;
  currency: string;
  customerName: string;
...
export function SquareShipmentPaymentForm({
  shipmentId,
  amount,
  currency,
  customerName,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      addToast({
        title: "Shipment payment received",
        description: "Your shipment charge was paid successfully.",
        color: "success"
      });
