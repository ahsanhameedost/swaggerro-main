...
export function mapProductToState(product: CatalogProductDetail): ProductEditorState {
  ...
  return {
    ...
    costPrice: record.costPrice == null ? null : readNumber(record.costPrice, 0),
    ...
    leadTimeDays: record.leadTimeDays == null ? null : Math.max(0, readNumber(record.leadTimeDays, 0)),
    commissionType: readString(record.commissionType, "PERCENT") === "FLAT" ? "FLAT" : "PERCENT",
    commissionValue: record.commissionValue == null ? null : readNumber(record.commissionValue, 0),
