...
import { ExternalLink, LayoutGrid, LogOut, Settings, ShoppingBag, Store, TicketPercent, Wallet } from "lucide-react";
...
const NAV = [
  ...
  { href: "/seller/coupons", label: "Coupons", icon: TicketPercent, exact: false },
